...
const Map: React.FC<MapProps> = ({ incidents, onSelectIncident, selectedIncidentId }) => {
  ...
  useEffect(() => {
    ...
    const points = g.selectAll('.incident-point')
      ...
      .on('click', (event, d) => onSelectIncident(d));
  ...
  }, [worldData, incidents, selectedIncidentId]);
      ...
      {incidents.length === 0 && (
        <div className="absolute inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="text-[10px] font-mono uppercase tracking-widest text-white/40">Synchronizing Global Intelligence...</div>
          </div>
        </div>
      )}
